    ...
    public class CreatePackageViewModel : BindableBase, INavigationAware
    {
        ...
        public GuiMetaDataModel SelectedOwnerDataModel
        {
            ...
            set
            {
                ...
                if (_EnterElementIfOneNotDeletedEntryIsNotFilled(MetaDataOwners, _selectedOwnerDataModel.Entity, _selectedOwnerDataModel.ContactPerson, _selectedOwnerDataModel.Telephone, _selectedOwnerDataModel.Email, _selectedOwnerDataModel.Address) == false)
                {
                    MetaDataOwners.Add(new GuiMetaDataModel(_selectedOwnerDataModel.Entity, _selectedOwnerDataModel.ContactPerson, _selectedOwnerDataModel.Telephone, _selectedOwnerDataModel.Email, _selectedOwnerDataModel.Address));
                }
            }
        }
        ...
        public GuiMetaDataModel SelectedCreatorDataModel
        {
            ...
            {
                SetProperty(ref _selectedCreatorDataModel, value);
                if (_EnterElementIfOneNotDeletedEntryIsNotFilled(MetaDataArchiveCreators, _selectedCreatorDataModel.Entity, _selectedCreatorDataModel.ContactPerson, _selectedCreatorDataModel.Telephone, _selectedCreatorDataModel.Email, _selectedCreatorDataModel.Address) == false)
                {
                    MetaDataArchiveCreators.Add(new GuiMetaDataModel(_selectedCreatorDataModel.Entity, _selectedCreatorDataModel.ContactPerson, _selectedCreatorDataModel.Telephone, _selectedCreatorDataModel.Email, _selectedCreatorDataModel.Address));
                }
            }
        }
        ...
        private bool _EnterElementIfOneNotDeletedEntryIsNotFilled(ObservableCollection<GuiMetaDataModel> collection, string entity, string contactPerson, string telephone, string email, string address)
        {
